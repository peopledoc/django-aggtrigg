...
#
# For standard installation of django-aggtrigg, see INSTALL.
# For details about django-aggtrigg's development environment, see CONTRIBUTING.rst.
#
PIP = pip
TOX = tox
PROJECT = $(shell python -c "import setup; print setup.NAME")
DEMO = django-aggtrigg-demo
